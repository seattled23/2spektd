...
All notable changes to 2spektd will be documented in this file.
...
### Added
- Initial release of 2spektd
- 12-layer validation framework
- Support for 4 languages (Go, TypeScript, Python, Shell)
- `/2spektd:new` skill for building new components
- `/2spektd:upgrade` skill for validating existing code
...
[Unreleased]: https://github.com/seattled23/2spektd/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/seattled23/2spektd/releases/tag/v1.0.0
